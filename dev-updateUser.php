...
//echo 'Update User on staging server using our API class<br />';
...
$uid = 23234;
$data = $R->UpdateUser(     $R->protocol() . '://staging-api.example.com', $uid, $user);//did not set up an SSL for this thats why the url is http and not https
print_r($data);
